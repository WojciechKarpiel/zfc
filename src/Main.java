                            ...
                            new Ast.IntroForall(jakisZbior,
                                    new Ast.IntroAnd(
                                            ...
                                            new Ast.IntroImpl(  Formula.constant("elo",List.of(),in(jakisZbior,p1) ),
                                                    implX, new ElimNot(new Apply(p1P, jakisZbior ),implX, Formula.constant("hehe", List.of(),in(jakisZbior,p2 /*2!*/)) ,qq,qq  ))
                                            ,
                                            // tu będzie to samo
                                            new Ast.IntroImpl(  Formula.constant("elo2",List.of(),in(jakisZbior,p2) ),
                                                    implX, new ElimNot(new Apply(p2P, jakisZbior ),implX, Formula.constant("hehe2", List.of(),in(jakisZbior,p1 )) ,qq,qq  ))
                                    )
                                    )
